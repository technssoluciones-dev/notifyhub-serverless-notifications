...
import type { DeregisterTargetFromMaintenanceWindowRequest, DeregisterTargetFromMaintenanceWindowResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DeregisterTargetFromMaintenanceWindowCommand_base: {
    new (input: DeregisterTargetFromMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<DeregisterTargetFromMaintenanceWindowCommandInput, DeregisterTargetFromMaintenanceWindowCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeregisterTargetFromMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<DeregisterTargetFromMaintenanceWindowCommandInput, DeregisterTargetFromMaintenanceWindowCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
