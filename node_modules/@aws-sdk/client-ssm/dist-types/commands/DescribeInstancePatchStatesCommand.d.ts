...
declare const DescribeInstancePatchStatesCommand_base: {
    new (input: DescribeInstancePatchStatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstancePatchStatesCommandInput, DescribeInstancePatchStatesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeInstancePatchStatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstancePatchStatesCommandInput, DescribeInstancePatchStatesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
