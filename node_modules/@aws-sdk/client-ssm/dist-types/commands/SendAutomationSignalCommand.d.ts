...
declare const SendAutomationSignalCommand_base: {
    new (input: SendAutomationSignalCommandInput): import("@smithy/core/client").CommandImpl<SendAutomationSignalCommandInput, SendAutomationSignalCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendAutomationSignalCommandInput): import("@smithy/core/client").CommandImpl<SendAutomationSignalCommandInput, SendAutomationSignalCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
