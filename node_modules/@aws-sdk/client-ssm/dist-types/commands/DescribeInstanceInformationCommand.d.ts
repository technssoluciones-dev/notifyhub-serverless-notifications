...
import type { DescribeInstanceInformationRequest, DescribeInstanceInformationResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeInstanceInformationCommand_base: {
    new (input: DescribeInstanceInformationCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceInformationCommandInput, DescribeInstanceInformationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceInformationCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceInformationCommandInput, DescribeInstanceInformationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
