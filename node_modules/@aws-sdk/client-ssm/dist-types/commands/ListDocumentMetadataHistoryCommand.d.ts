...
declare const ListDocumentMetadataHistoryCommand_base: {
    new (input: ListDocumentMetadataHistoryCommandInput): import("@smithy/core/client").CommandImpl<ListDocumentMetadataHistoryCommandInput, ListDocumentMetadataHistoryCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDocumentMetadataHistoryCommandInput): import("@smithy/core/client").CommandImpl<ListDocumentMetadataHistoryCommandInput, ListDocumentMetadataHistoryCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
