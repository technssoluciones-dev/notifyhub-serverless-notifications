...
import type { DescribeMaintenanceWindowExecutionTasksRequest, DescribeMaintenanceWindowExecutionTasksResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeMaintenanceWindowExecutionTasksCommand_base: {
    new (input: DescribeMaintenanceWindowExecutionTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeMaintenanceWindowExecutionTasksCommandInput, DescribeMaintenanceWindowExecutionTasksCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMaintenanceWindowExecutionTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeMaintenanceWindowExecutionTasksCommandInput, DescribeMaintenanceWindowExecutionTasksCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
