...
declare const DescribeInstancePatchesCommand_base: {
    new (input: DescribeInstancePatchesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstancePatchesCommandInput, DescribeInstancePatchesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeInstancePatchesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstancePatchesCommandInput, DescribeInstancePatchesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
