...
import type { UpdateResourceDataSyncRequest, UpdateResourceDataSyncResult } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateResourceDataSyncCommand_base: {
    new (input: UpdateResourceDataSyncCommandInput): import("@smithy/core/client").CommandImpl<UpdateResourceDataSyncCommandInput, UpdateResourceDataSyncCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateResourceDataSyncCommandInput): import("@smithy/core/client").CommandImpl<UpdateResourceDataSyncCommandInput, UpdateResourceDataSyncCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
