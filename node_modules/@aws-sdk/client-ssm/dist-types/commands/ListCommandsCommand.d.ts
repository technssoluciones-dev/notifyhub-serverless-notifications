...
import type { ListCommandsRequest, ListCommandsResult } from "../models/models_1";
/**
 * @public
 */
...
declare const ListCommandsCommand_base: {
    new (input: ListCommandsCommandInput): import("@smithy/core/client").CommandImpl<ListCommandsCommandInput, ListCommandsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCommandsCommandInput]): import("@smithy/core/client").CommandImpl<ListCommandsCommandInput, ListCommandsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
