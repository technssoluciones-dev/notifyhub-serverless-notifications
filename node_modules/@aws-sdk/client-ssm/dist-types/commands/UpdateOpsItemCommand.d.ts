...
declare const UpdateOpsItemCommand_base: {
    new (input: UpdateOpsItemCommandInput): import("@smithy/core/client").CommandImpl<UpdateOpsItemCommandInput, UpdateOpsItemCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateOpsItemCommandInput): import("@smithy/core/client").CommandImpl<UpdateOpsItemCommandInput, UpdateOpsItemCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
