...
declare const DescribeAssociationExecutionsCommand_base: {
    new (input: DescribeAssociationExecutionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAssociationExecutionsCommandInput, DescribeAssociationExecutionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAssociationExecutionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAssociationExecutionsCommandInput, DescribeAssociationExecutionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
