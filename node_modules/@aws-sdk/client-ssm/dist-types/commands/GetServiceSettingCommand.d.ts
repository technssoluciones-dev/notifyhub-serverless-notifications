...
declare const GetServiceSettingCommand_base: {
    new (input: GetServiceSettingCommandInput): import("@smithy/core/client").CommandImpl<GetServiceSettingCommandInput, GetServiceSettingCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetServiceSettingCommandInput): import("@smithy/core/client").CommandImpl<GetServiceSettingCommandInput, GetServiceSettingCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
