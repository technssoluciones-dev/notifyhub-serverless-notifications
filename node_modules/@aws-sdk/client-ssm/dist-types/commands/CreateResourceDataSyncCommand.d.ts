...
import type { CreateResourceDataSyncRequest, CreateResourceDataSyncResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateResourceDataSyncCommand_base: {
    new (input: CreateResourceDataSyncCommandInput): import("@smithy/core/client").CommandImpl<CreateResourceDataSyncCommandInput, CreateResourceDataSyncCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateResourceDataSyncCommandInput): import("@smithy/core/client").CommandImpl<CreateResourceDataSyncCommandInput, CreateResourceDataSyncCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
