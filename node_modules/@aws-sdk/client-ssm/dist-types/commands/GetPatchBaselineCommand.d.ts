...
declare const GetPatchBaselineCommand_base: {
    new (input: GetPatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<GetPatchBaselineCommandInput, GetPatchBaselineCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<GetPatchBaselineCommandInput, GetPatchBaselineCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
