...
declare const UpdateMaintenanceWindowTargetCommand_base: {
    new (input: UpdateMaintenanceWindowTargetCommandInput): import("@smithy/core/client").CommandImpl<UpdateMaintenanceWindowTargetCommandInput, UpdateMaintenanceWindowTargetCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMaintenanceWindowTargetCommandInput): import("@smithy/core/client").CommandImpl<UpdateMaintenanceWindowTargetCommandInput, UpdateMaintenanceWindowTargetCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
