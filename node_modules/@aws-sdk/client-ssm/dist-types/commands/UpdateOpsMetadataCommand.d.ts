...
declare const UpdateOpsMetadataCommand_base: {
    new (input: UpdateOpsMetadataCommandInput): import("@smithy/core/client").CommandImpl<UpdateOpsMetadataCommandInput, UpdateOpsMetadataCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateOpsMetadataCommandInput): import("@smithy/core/client").CommandImpl<UpdateOpsMetadataCommandInput, UpdateOpsMetadataCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
