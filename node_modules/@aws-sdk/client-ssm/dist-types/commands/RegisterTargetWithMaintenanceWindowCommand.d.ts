...
import type { RegisterTargetWithMaintenanceWindowRequest, RegisterTargetWithMaintenanceWindowResult } from "../models/models_1";
/**
 * @public
 */
...
declare const RegisterTargetWithMaintenanceWindowCommand_base: {
    new (input: RegisterTargetWithMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<RegisterTargetWithMaintenanceWindowCommandInput, RegisterTargetWithMaintenanceWindowCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterTargetWithMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<RegisterTargetWithMaintenanceWindowCommandInput, RegisterTargetWithMaintenanceWindowCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
