...
declare const RegisterDefaultPatchBaselineCommand_base: {
    new (input: RegisterDefaultPatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<RegisterDefaultPatchBaselineCommandInput, RegisterDefaultPatchBaselineCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterDefaultPatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<RegisterDefaultPatchBaselineCommandInput, RegisterDefaultPatchBaselineCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
