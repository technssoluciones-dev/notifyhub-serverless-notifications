...
import type { GetMaintenanceWindowTaskRequest, GetMaintenanceWindowTaskResult } from "../models/models_0";
/**
 * @public
 */
...
declare const GetMaintenanceWindowTaskCommand_base: {
    new (input: GetMaintenanceWindowTaskCommandInput): import("@smithy/core/client").CommandImpl<GetMaintenanceWindowTaskCommandInput, GetMaintenanceWindowTaskCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMaintenanceWindowTaskCommandInput): import("@smithy/core/client").CommandImpl<GetMaintenanceWindowTaskCommandInput, GetMaintenanceWindowTaskCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
