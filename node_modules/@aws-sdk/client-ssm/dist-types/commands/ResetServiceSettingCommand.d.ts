...
import type { ResetServiceSettingRequest, ResetServiceSettingResult } from "../models/models_1";
/**
 * @public
 */
...
declare const ResetServiceSettingCommand_base: {
    new (input: ResetServiceSettingCommandInput): import("@smithy/core/client").CommandImpl<ResetServiceSettingCommandInput, ResetServiceSettingCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResetServiceSettingCommandInput): import("@smithy/core/client").CommandImpl<ResetServiceSettingCommandInput, ResetServiceSettingCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
