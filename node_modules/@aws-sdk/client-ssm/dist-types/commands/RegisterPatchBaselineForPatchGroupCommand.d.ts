...
import type { RegisterPatchBaselineForPatchGroupRequest, RegisterPatchBaselineForPatchGroupResult } from "../models/models_1";
/**
 * @public
 */
...
declare const RegisterPatchBaselineForPatchGroupCommand_base: {
    new (input: RegisterPatchBaselineForPatchGroupCommandInput): import("@smithy/core/client").CommandImpl<RegisterPatchBaselineForPatchGroupCommandInput, RegisterPatchBaselineForPatchGroupCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterPatchBaselineForPatchGroupCommandInput): import("@smithy/core/client").CommandImpl<RegisterPatchBaselineForPatchGroupCommandInput, RegisterPatchBaselineForPatchGroupCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
