...
declare const ListOpsMetadataCommand_base: {
    new (input: ListOpsMetadataCommandInput): import("@smithy/core/client").CommandImpl<ListOpsMetadataCommandInput, ListOpsMetadataCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListOpsMetadataCommandInput]): import("@smithy/core/client").CommandImpl<ListOpsMetadataCommandInput, ListOpsMetadataCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
