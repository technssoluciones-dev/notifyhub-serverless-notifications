...
declare const DeleteAssociationCommand_base: {
    new (input: DeleteAssociationCommandInput): import("@smithy/core/client").CommandImpl<DeleteAssociationCommandInput, DeleteAssociationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteAssociationCommandInput]): import("@smithy/core/client").CommandImpl<DeleteAssociationCommandInput, DeleteAssociationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
