...
declare const UpdateDocumentDefaultVersionCommand_base: {
    new (input: UpdateDocumentDefaultVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdateDocumentDefaultVersionCommandInput, UpdateDocumentDefaultVersionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDocumentDefaultVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdateDocumentDefaultVersionCommandInput, UpdateDocumentDefaultVersionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
