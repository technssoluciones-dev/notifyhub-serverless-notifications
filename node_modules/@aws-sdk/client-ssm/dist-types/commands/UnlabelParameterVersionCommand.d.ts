...
declare const UnlabelParameterVersionCommand_base: {
    new (input: UnlabelParameterVersionCommandInput): import("@smithy/core/client").CommandImpl<UnlabelParameterVersionCommandInput, UnlabelParameterVersionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UnlabelParameterVersionCommandInput): import("@smithy/core/client").CommandImpl<UnlabelParameterVersionCommandInput, UnlabelParameterVersionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
