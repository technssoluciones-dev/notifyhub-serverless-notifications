...
declare const UpdateManagedInstanceRoleCommand_base: {
    new (input: UpdateManagedInstanceRoleCommandInput): import("@smithy/core/client").CommandImpl<UpdateManagedInstanceRoleCommandInput, UpdateManagedInstanceRoleCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateManagedInstanceRoleCommandInput): import("@smithy/core/client").CommandImpl<UpdateManagedInstanceRoleCommandInput, UpdateManagedInstanceRoleCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
