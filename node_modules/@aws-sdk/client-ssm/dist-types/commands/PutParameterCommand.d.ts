...
declare const PutParameterCommand_base: {
    new (input: PutParameterCommandInput): import("@smithy/core/client").CommandImpl<PutParameterCommandInput, PutParameterCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutParameterCommandInput): import("@smithy/core/client").CommandImpl<PutParameterCommandInput, PutParameterCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
