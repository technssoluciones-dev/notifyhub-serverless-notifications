...
declare const ListInventoryEntriesCommand_base: {
    new (input: ListInventoryEntriesCommandInput): import("@smithy/core/client").CommandImpl<ListInventoryEntriesCommandInput, ListInventoryEntriesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListInventoryEntriesCommandInput): import("@smithy/core/client").CommandImpl<ListInventoryEntriesCommandInput, ListInventoryEntriesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
