...
import type { ListCommandInvocationsRequest, ListCommandInvocationsResult } from "../models/models_1";
/**
 * @public
 */
...
declare const ListCommandInvocationsCommand_base: {
    new (input: ListCommandInvocationsCommandInput): import("@smithy/core/client").CommandImpl<ListCommandInvocationsCommandInput, ListCommandInvocationsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCommandInvocationsCommandInput]): import("@smithy/core/client").CommandImpl<ListCommandInvocationsCommandInput, ListCommandInvocationsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
