...
declare const ListResourceComplianceSummariesCommand_base: {
    new (input: ListResourceComplianceSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListResourceComplianceSummariesCommandInput, ListResourceComplianceSummariesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListResourceComplianceSummariesCommandInput]): import("@smithy/core/client").CommandImpl<ListResourceComplianceSummariesCommandInput, ListResourceComplianceSummariesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
