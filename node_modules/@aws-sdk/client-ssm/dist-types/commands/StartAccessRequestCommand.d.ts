...
declare const StartAccessRequestCommand_base: {
    new (input: StartAccessRequestCommandInput): import("@smithy/core/client").CommandImpl<StartAccessRequestCommandInput, StartAccessRequestCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartAccessRequestCommandInput): import("@smithy/core/client").CommandImpl<StartAccessRequestCommandInput, StartAccessRequestCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
