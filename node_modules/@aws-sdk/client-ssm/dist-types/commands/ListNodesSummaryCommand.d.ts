...
declare const ListNodesSummaryCommand_base: {
    new (input: ListNodesSummaryCommandInput): import("@smithy/core/client").CommandImpl<ListNodesSummaryCommandInput, ListNodesSummaryCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListNodesSummaryCommandInput): import("@smithy/core/client").CommandImpl<ListNodesSummaryCommandInput, ListNodesSummaryCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
