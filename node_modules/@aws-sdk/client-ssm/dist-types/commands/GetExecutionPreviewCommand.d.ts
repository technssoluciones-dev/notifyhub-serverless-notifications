...
declare const GetExecutionPreviewCommand_base: {
    new (input: GetExecutionPreviewCommandInput): import("@smithy/core/client").CommandImpl<GetExecutionPreviewCommandInput, GetExecutionPreviewCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetExecutionPreviewCommandInput): import("@smithy/core/client").CommandImpl<GetExecutionPreviewCommandInput, GetExecutionPreviewCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
