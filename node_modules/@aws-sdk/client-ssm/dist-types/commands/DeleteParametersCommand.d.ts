...
declare const DeleteParametersCommand_base: {
    new (input: DeleteParametersCommandInput): import("@smithy/core/client").CommandImpl<DeleteParametersCommandInput, DeleteParametersCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteParametersCommandInput): import("@smithy/core/client").CommandImpl<DeleteParametersCommandInput, DeleteParametersCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
