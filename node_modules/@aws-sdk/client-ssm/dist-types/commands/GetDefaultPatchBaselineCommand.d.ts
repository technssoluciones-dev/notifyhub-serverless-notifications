...
declare const GetDefaultPatchBaselineCommand_base: {
    new (input: GetDefaultPatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<GetDefaultPatchBaselineCommandInput, GetDefaultPatchBaselineCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetDefaultPatchBaselineCommandInput]): import("@smithy/core/client").CommandImpl<GetDefaultPatchBaselineCommandInput, GetDefaultPatchBaselineCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
