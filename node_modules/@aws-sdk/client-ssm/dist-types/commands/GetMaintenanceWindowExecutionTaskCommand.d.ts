...
import type { GetMaintenanceWindowExecutionTaskRequest, GetMaintenanceWindowExecutionTaskResult } from "../models/models_0";
/**
 * @public
 */
...
declare const GetMaintenanceWindowExecutionTaskCommand_base: {
    new (input: GetMaintenanceWindowExecutionTaskCommandInput): import("@smithy/core/client").CommandImpl<GetMaintenanceWindowExecutionTaskCommandInput, GetMaintenanceWindowExecutionTaskCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMaintenanceWindowExecutionTaskCommandInput): import("@smithy/core/client").CommandImpl<GetMaintenanceWindowExecutionTaskCommandInput, GetMaintenanceWindowExecutionTaskCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
