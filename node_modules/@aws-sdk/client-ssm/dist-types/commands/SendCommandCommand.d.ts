...
declare const SendCommandCommand_base: {
    new (input: SendCommandCommandInput): import("@smithy/core/client").CommandImpl<SendCommandCommandInput, SendCommandCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendCommandCommandInput): import("@smithy/core/client").CommandImpl<SendCommandCommandInput, SendCommandCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
