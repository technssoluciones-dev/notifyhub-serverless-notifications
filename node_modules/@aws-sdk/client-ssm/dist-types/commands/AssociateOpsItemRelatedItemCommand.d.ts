...
declare const AssociateOpsItemRelatedItemCommand_base: {
    new (input: AssociateOpsItemRelatedItemCommandInput): import("@smithy/core/client").CommandImpl<AssociateOpsItemRelatedItemCommandInput, AssociateOpsItemRelatedItemCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateOpsItemRelatedItemCommandInput): import("@smithy/core/client").CommandImpl<AssociateOpsItemRelatedItemCommandInput, AssociateOpsItemRelatedItemCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
