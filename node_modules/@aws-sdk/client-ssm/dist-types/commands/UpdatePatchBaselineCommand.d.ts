...
declare const UpdatePatchBaselineCommand_base: {
    new (input: UpdatePatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<UpdatePatchBaselineCommandInput, UpdatePatchBaselineCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<UpdatePatchBaselineCommandInput, UpdatePatchBaselineCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
