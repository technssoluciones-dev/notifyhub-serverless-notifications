...
declare const ListOpsItemRelatedItemsCommand_base: {
    new (input: ListOpsItemRelatedItemsCommandInput): import("@smithy/core/client").CommandImpl<ListOpsItemRelatedItemsCommandInput, ListOpsItemRelatedItemsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListOpsItemRelatedItemsCommandInput]): import("@smithy/core/client").CommandImpl<ListOpsItemRelatedItemsCommandInput, ListOpsItemRelatedItemsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
