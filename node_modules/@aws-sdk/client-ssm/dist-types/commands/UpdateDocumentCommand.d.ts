...
declare const UpdateDocumentCommand_base: {
    new (input: UpdateDocumentCommandInput): import("@smithy/core/client").CommandImpl<UpdateDocumentCommandInput, UpdateDocumentCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDocumentCommandInput): import("@smithy/core/client").CommandImpl<UpdateDocumentCommandInput, UpdateDocumentCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
