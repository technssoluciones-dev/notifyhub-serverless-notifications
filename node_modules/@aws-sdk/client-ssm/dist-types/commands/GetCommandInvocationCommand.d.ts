...
declare const GetCommandInvocationCommand_base: {
    new (input: GetCommandInvocationCommandInput): import("@smithy/core/client").CommandImpl<GetCommandInvocationCommandInput, GetCommandInvocationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCommandInvocationCommandInput): import("@smithy/core/client").CommandImpl<GetCommandInvocationCommandInput, GetCommandInvocationCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
