...
declare const UpdateMaintenanceWindowTaskCommand_base: {
    new (input: UpdateMaintenanceWindowTaskCommandInput): import("@smithy/core/client").CommandImpl<UpdateMaintenanceWindowTaskCommandInput, UpdateMaintenanceWindowTaskCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMaintenanceWindowTaskCommandInput): import("@smithy/core/client").CommandImpl<UpdateMaintenanceWindowTaskCommandInput, UpdateMaintenanceWindowTaskCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
