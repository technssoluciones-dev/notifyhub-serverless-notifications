...
import type { DescribeMaintenanceWindowScheduleRequest, DescribeMaintenanceWindowScheduleResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeMaintenanceWindowScheduleCommand_base: {
    new (input: DescribeMaintenanceWindowScheduleCommandInput): import("@smithy/core/client").CommandImpl<DescribeMaintenanceWindowScheduleCommandInput, DescribeMaintenanceWindowScheduleCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeMaintenanceWindowScheduleCommandInput]): import("@smithy/core/client").CommandImpl<DescribeMaintenanceWindowScheduleCommandInput, DescribeMaintenanceWindowScheduleCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
