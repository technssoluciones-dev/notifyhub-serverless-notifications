...
declare const PutInventoryCommand_base: {
    new (input: PutInventoryCommandInput): import("@smithy/core/client").CommandImpl<PutInventoryCommandInput, PutInventoryCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutInventoryCommandInput): import("@smithy/core/client").CommandImpl<PutInventoryCommandInput, PutInventoryCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
