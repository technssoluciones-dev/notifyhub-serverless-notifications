...
declare const UpdateServiceSettingCommand_base: {
    new (input: UpdateServiceSettingCommandInput): import("@smithy/core/client").CommandImpl<UpdateServiceSettingCommandInput, UpdateServiceSettingCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateServiceSettingCommandInput): import("@smithy/core/client").CommandImpl<UpdateServiceSettingCommandInput, UpdateServiceSettingCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
