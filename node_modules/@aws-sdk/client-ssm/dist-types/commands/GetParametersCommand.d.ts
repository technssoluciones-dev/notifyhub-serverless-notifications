...
declare const GetParametersCommand_base: {
    new (input: GetParametersCommandInput): import("@smithy/core/client").CommandImpl<GetParametersCommandInput, GetParametersCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetParametersCommandInput): import("@smithy/core/client").CommandImpl<GetParametersCommandInput, GetParametersCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
