...
declare const TerminateSessionCommand_base: {
    new (input: TerminateSessionCommandInput): import("@smithy/core/client").CommandImpl<TerminateSessionCommandInput, TerminateSessionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TerminateSessionCommandInput): import("@smithy/core/client").CommandImpl<TerminateSessionCommandInput, TerminateSessionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
