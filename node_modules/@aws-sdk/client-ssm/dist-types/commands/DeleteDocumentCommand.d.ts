...
declare const DeleteDocumentCommand_base: {
    new (input: DeleteDocumentCommandInput): import("@smithy/core/client").CommandImpl<DeleteDocumentCommandInput, DeleteDocumentCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDocumentCommandInput): import("@smithy/core/client").CommandImpl<DeleteDocumentCommandInput, DeleteDocumentCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
