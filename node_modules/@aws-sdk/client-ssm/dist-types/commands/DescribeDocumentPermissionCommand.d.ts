...
declare const DescribeDocumentPermissionCommand_base: {
    new (input: DescribeDocumentPermissionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDocumentPermissionCommandInput, DescribeDocumentPermissionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDocumentPermissionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDocumentPermissionCommandInput, DescribeDocumentPermissionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
