...
import type { DescribeInstanceAssociationsStatusRequest, DescribeInstanceAssociationsStatusResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeInstanceAssociationsStatusCommand_base: {
    new (input: DescribeInstanceAssociationsStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceAssociationsStatusCommandInput, DescribeInstanceAssociationsStatusCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeInstanceAssociationsStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceAssociationsStatusCommandInput, DescribeInstanceAssociationsStatusCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
