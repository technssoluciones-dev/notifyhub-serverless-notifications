...
declare const GetAccessTokenCommand_base: {
    new (input: GetAccessTokenCommandInput): import("@smithy/core/client").CommandImpl<GetAccessTokenCommandInput, GetAccessTokenCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAccessTokenCommandInput): import("@smithy/core/client").CommandImpl<GetAccessTokenCommandInput, GetAccessTokenCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
