...
declare const ResumeSessionCommand_base: {
    new (input: ResumeSessionCommandInput): import("@smithy/core/client").CommandImpl<ResumeSessionCommandInput, ResumeSessionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResumeSessionCommandInput): import("@smithy/core/client").CommandImpl<ResumeSessionCommandInput, ResumeSessionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
