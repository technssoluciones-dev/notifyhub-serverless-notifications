...
declare const ModifyDocumentPermissionCommand_base: {
    new (input: ModifyDocumentPermissionCommandInput): import("@smithy/core/client").CommandImpl<ModifyDocumentPermissionCommandInput, ModifyDocumentPermissionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyDocumentPermissionCommandInput): import("@smithy/core/client").CommandImpl<ModifyDocumentPermissionCommandInput, ModifyDocumentPermissionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
