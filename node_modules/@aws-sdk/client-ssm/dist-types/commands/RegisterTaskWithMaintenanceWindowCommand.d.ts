...
import type { RegisterTaskWithMaintenanceWindowRequest, RegisterTaskWithMaintenanceWindowResult } from "../models/models_1";
/**
 * @public
 */
...
declare const RegisterTaskWithMaintenanceWindowCommand_base: {
    new (input: RegisterTaskWithMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<RegisterTaskWithMaintenanceWindowCommandInput, RegisterTaskWithMaintenanceWindowCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterTaskWithMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<RegisterTaskWithMaintenanceWindowCommandInput, RegisterTaskWithMaintenanceWindowCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
