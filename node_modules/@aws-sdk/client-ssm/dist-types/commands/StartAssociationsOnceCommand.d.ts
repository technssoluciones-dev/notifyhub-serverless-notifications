...
import type { StartAssociationsOnceRequest, StartAssociationsOnceResult } from "../models/models_1";
/**
 * @public
 */
...
declare const StartAssociationsOnceCommand_base: {
    new (input: StartAssociationsOnceCommandInput): import("@smithy/core/client").CommandImpl<StartAssociationsOnceCommandInput, StartAssociationsOnceCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartAssociationsOnceCommandInput): import("@smithy/core/client").CommandImpl<StartAssociationsOnceCommandInput, StartAssociationsOnceCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
