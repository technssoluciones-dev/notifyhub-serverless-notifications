...
declare const ListResourceDataSyncCommand_base: {
    new (input: ListResourceDataSyncCommandInput): import("@smithy/core/client").CommandImpl<ListResourceDataSyncCommandInput, ListResourceDataSyncCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListResourceDataSyncCommandInput]): import("@smithy/core/client").CommandImpl<ListResourceDataSyncCommandInput, ListResourceDataSyncCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
