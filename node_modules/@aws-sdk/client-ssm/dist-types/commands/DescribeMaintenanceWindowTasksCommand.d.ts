...
declare const DescribeMaintenanceWindowTasksCommand_base: {
    new (input: DescribeMaintenanceWindowTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeMaintenanceWindowTasksCommandInput, DescribeMaintenanceWindowTasksCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMaintenanceWindowTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeMaintenanceWindowTasksCommandInput, DescribeMaintenanceWindowTasksCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
