...
declare const ListComplianceSummariesCommand_base: {
    new (input: ListComplianceSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListComplianceSummariesCommandInput, ListComplianceSummariesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListComplianceSummariesCommandInput]): import("@smithy/core/client").CommandImpl<ListComplianceSummariesCommandInput, ListComplianceSummariesCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
