...
declare const DeregisterManagedInstanceCommand_base: {
    new (input: DeregisterManagedInstanceCommandInput): import("@smithy/core/client").CommandImpl<DeregisterManagedInstanceCommandInput, DeregisterManagedInstanceCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeregisterManagedInstanceCommandInput): import("@smithy/core/client").CommandImpl<DeregisterManagedInstanceCommandInput, DeregisterManagedInstanceCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
