...
declare const DisassociateOpsItemRelatedItemCommand_base: {
    new (input: DisassociateOpsItemRelatedItemCommandInput): import("@smithy/core/client").CommandImpl<DisassociateOpsItemRelatedItemCommandInput, DisassociateOpsItemRelatedItemCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateOpsItemRelatedItemCommandInput): import("@smithy/core/client").CommandImpl<DisassociateOpsItemRelatedItemCommandInput, DisassociateOpsItemRelatedItemCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
