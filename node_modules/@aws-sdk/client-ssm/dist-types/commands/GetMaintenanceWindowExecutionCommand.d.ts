...
declare const GetMaintenanceWindowExecutionCommand_base: {
    new (input: GetMaintenanceWindowExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetMaintenanceWindowExecutionCommandInput, GetMaintenanceWindowExecutionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMaintenanceWindowExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetMaintenanceWindowExecutionCommandInput, GetMaintenanceWindowExecutionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
