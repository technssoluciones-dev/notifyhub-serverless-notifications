...
declare const ListDocumentVersionsCommand_base: {
    new (input: ListDocumentVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListDocumentVersionsCommandInput, ListDocumentVersionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDocumentVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListDocumentVersionsCommandInput, ListDocumentVersionsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
