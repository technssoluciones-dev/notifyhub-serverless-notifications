...
declare const ListComplianceItemsCommand_base: {
    new (input: ListComplianceItemsCommandInput): import("@smithy/core/client").CommandImpl<ListComplianceItemsCommandInput, ListComplianceItemsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListComplianceItemsCommandInput]): import("@smithy/core/client").CommandImpl<ListComplianceItemsCommandInput, ListComplianceItemsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
