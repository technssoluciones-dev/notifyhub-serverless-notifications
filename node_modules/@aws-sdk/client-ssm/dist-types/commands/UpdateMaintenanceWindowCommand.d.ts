...
declare const UpdateMaintenanceWindowCommand_base: {
    new (input: UpdateMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<UpdateMaintenanceWindowCommandInput, UpdateMaintenanceWindowCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<UpdateMaintenanceWindowCommandInput, UpdateMaintenanceWindowCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
