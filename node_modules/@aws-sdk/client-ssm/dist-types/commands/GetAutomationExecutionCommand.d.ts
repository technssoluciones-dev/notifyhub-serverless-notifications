...
declare const GetAutomationExecutionCommand_base: {
    new (input: GetAutomationExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetAutomationExecutionCommandInput, GetAutomationExecutionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAutomationExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetAutomationExecutionCommandInput, GetAutomationExecutionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
