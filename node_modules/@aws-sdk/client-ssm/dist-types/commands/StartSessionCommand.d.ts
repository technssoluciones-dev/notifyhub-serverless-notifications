...
declare const StartSessionCommand_base: {
    new (input: StartSessionCommandInput): import("@smithy/core/client").CommandImpl<StartSessionCommandInput, StartSessionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartSessionCommandInput): import("@smithy/core/client").CommandImpl<StartSessionCommandInput, StartSessionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
