...
declare const LabelParameterVersionCommand_base: {
    new (input: LabelParameterVersionCommandInput): import("@smithy/core/client").CommandImpl<LabelParameterVersionCommandInput, LabelParameterVersionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: LabelParameterVersionCommandInput): import("@smithy/core/client").CommandImpl<LabelParameterVersionCommandInput, LabelParameterVersionCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
