...
declare const DescribeParametersCommand_base: {
    new (input: DescribeParametersCommandInput): import("@smithy/core/client").CommandImpl<DescribeParametersCommandInput, DescribeParametersCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeParametersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeParametersCommandInput, DescribeParametersCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
