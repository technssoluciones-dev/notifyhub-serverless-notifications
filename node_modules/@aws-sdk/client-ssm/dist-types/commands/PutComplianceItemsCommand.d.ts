...
declare const PutComplianceItemsCommand_base: {
    new (input: PutComplianceItemsCommandInput): import("@smithy/core/client").CommandImpl<PutComplianceItemsCommandInput, PutComplianceItemsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutComplianceItemsCommandInput): import("@smithy/core/client").CommandImpl<PutComplianceItemsCommandInput, PutComplianceItemsCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
