...
declare const AddTagsToResourceCommand_base: {
    new (input: AddTagsToResourceCommandInput): import("@smithy/core/client").CommandImpl<AddTagsToResourceCommandInput, AddTagsToResourceCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AddTagsToResourceCommandInput): import("@smithy/core/client").CommandImpl<AddTagsToResourceCommandInput, AddTagsToResourceCommandOutput, import("..").SSMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
